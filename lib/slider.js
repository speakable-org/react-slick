...
var Slider = (function(_React$Component) {
  ...
  Slider.prototype.render = function render() {
    ...
    var slidesPerRow = settings.slidesPerRow || 1;
    var variableWidth = settings.variableWidth || false;
    ...
    for (var i = 0; i < children.length; i += rows * slidesPerRow) {
      var newSlide = [];
      for (var j = i; j < i + rows * slidesPerRow; j += slidesPerRow) {
        var row = [];
        for (var k = j; k < j + slidesPerRow; k += 1) {
